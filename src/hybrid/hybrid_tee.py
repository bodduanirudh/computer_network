...
class HybridTDMFDMTree:
    def __init__(self, tree_topology, num_time_slots, num_frequency_bands):
    ...
    def allocate_slots(self):
        allocations = {}
        for i, node in enumerate(self.tree_topology.nodes):
    ...
    def simulate_hybrid_transmission(self):
        print("Hybrid TDM-FDM Tree Simulation:")
        results = []
    ...
    def save_results_to_csv(self, results, filename='hybrid_tree_simulation.csv'):
